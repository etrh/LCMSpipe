...
xsg.pos.centw.retcor.obiwarp <- retcor.obiwarp(xsg.pos.centw, family="gaussian", plottype="mdevden")
xsg.pos.mquant.retcor.obiwarp <- retcor.obiwarp(xsg.pos.mquant, family="gaussian", plottype="mdevden")

xsg.neg.centw.retcor.obiwarp <- retcor.obiwarp(xsg.neg.centw, family="gaussian", plottype="mdevden")
xsg.neg.mquant.retcor.obiwarp <- retcor.obiwarp(xsg.neg.mquant, family="gaussian", plottype="mdevden")

xsg.pos.centw.mzClust.retcor.obiwarp <- retcor.obiwarp(xsg.pos.centw.mzClust, family="gaussian", plottype="mdevden")
xsg.pos.mquant.mzClust.retcor.obiwarp <- retcor.obiwarp(xsg.pos.mquant.mzClust, family="gaussian", plottype="mdevden")

xsg.neg.centw.mzClust.retcor.obiwarp <- retcor.obiwarp(xsg.neg.centw.mzClust, family="gaussian", plottype="mdevden")
xsg.neg.mquant.mzClust.retcor.obiwarp <- retcor.obiwarp(xsg.neg.mquant.mzClust, family="gaussian", plottype="mdevden")
```
