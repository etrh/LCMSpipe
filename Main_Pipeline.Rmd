...
library(xcms)
pacman::p_load("IPO")
pacman::p_load("MASS", "rgl", "mzR", "splines", "doParallel", "foreach", "iterators", "snow", "ROCR", "ROCS", "e1071", "randomForest", "gbm" , "rJava", "RColorBrewer", "plotly", "multtest", "XML", "caTools", "bitops", "ptw", "gplots", "tcltk2")
...
#rep.gaus <- diffreport(xsg.gaus, "Fresh", "Refrozen", "report", 10, metlin=0.15)
rep.gaus <- diffreport(object=xsg.gaus, class1=c("Mouse1", "Mouse2"), class2="Mouse5", filebase="report", 50, metlin=0.15)
...
write.csv(dat, file='PeakIntensityMatrix_Fresh_and_FreshRerun.csv')
rm(dat)
...
Another way to analyze the data is using the MSnbase package
...
```{r apLCMS}
#fresh.samples.apLCMS.analysis <- apLCMS::cdf.to.ftr(getwd(), file.pattern = ".mzXML")
```