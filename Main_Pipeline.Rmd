...
pacman::p_load("Rserve", "som", "ROCR", "RJSONIO", "Cairo", "pheatmap", "lattice", "pROC", "ellipse", "scatterplot3d", "siggenes", "globaltest", "GlobalAncova", "Rgraphviz", "KEGGgraph", "SSPA", "sva", "car", "fitdistrplus", "R.utils")
...
for(i in 1:length(significant_features_mz)){
  lower_bound <- significant_features_mz[i] - ppm
  upper_bound <- significant_features_mz[i] + ppm
