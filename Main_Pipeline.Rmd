...
"Derivative signals such as isotopes, adducts, dimers and fragments, can be automatically annotated by correlation analysis on both signal shape and intensity patterns using software tools like CAMERA [53], PUTMEDID-LCMS [54] and mzMatch [55]. Such peaks are not discarded, but only flagged, so that their assigned annotations can be taken into account in the metabolite identification step."
