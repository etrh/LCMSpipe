...
peakpickingParameters$max_peakwidth <- c(28,60)
peakpickingParameters$ppm <- c(5,30)
peakpickingParameters$snthresh <- c(3,20)
peakpickingParameters$noise <- 6000
peakpickingParameters$prefilter <- c(3,5)
peakpickingParameters$value_of_prefilter <- c(7000,12000)
peakpickingParameters$fitgauss <- TRUE

data <- list.files("Data/Mzb1/", recursive = T, full.names = T, pattern = ".mzML")
...
msd_raw <- extractMsData(raw_data, mz = mzr, rt = rtr) ## Extract the MS data for the region
