...
top.features.intensity$SPLSDA$Stat.Method <- rep("SPLSDA", top.features.intensity$PLSDA %>% nrow)
top.features.intensity$Volcano$Stat.Method <- rep("Volcano", top.features.intensity$PLSDA %>% nrow)
