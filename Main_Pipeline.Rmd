...
- Convert .d folders (Agilent proprietary format) to mzXML or mzML using MSConvert from the ProteoWizard toolbox  
...
pacman::p_load("MASS", "rgl", "splines", "parallel","doParallel", "foreach", "iterators", "snow", "ROCR", "ROCS", "e1071", "randomForest", "gbm" , "rJava", "RColorBrewer", "plotly", "multtest", "XML", "caTools", "bitops", "ptw", "gplots", "tcltk2", "IPO")
...
pos.mzml <- list.files(path.pos, recursive = T, full.names = T, pattern=".mzXML")
pos.mzml
```
