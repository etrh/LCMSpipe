...
- MetFrag using MS/MS data (we do not have any MS/MS data yet...)  
...
- `IPO` is computationally-expensive for large datasets, `MPI` packages/approaches can be useful (e.g. `pbdMPI`, `Rmpi`) (https://en.wikipedia.org/wiki/Programming_with_Big_Data_in_R)  
  
  
https://bioconductor.org/packages/release/bioc/vignettes/metabomxtr/inst/doc/Metabomxtr_Vignette.pdf  
https://bioconductor.org/packages/release/bioc/vignettes/metabomxtr/inst/doc/mixnorm_Vignette.pdf  
https://www.bioconductor.org/packages/release/bioc/manuals/metabomxtr/man/metabomxtr.pdf  
https://bioconductor.org/packages/release/bioc/vignettes/BiGGR/inst/doc/BiGGR.pdf  
https://bioconductor.org/packages/release/bioc/vignettes/LOBSTAHS/inst/doc/LOBSTAHS.html  
https://bioconductor.org/packages/release/bioc/vignettes/MAIT/inst/doc/MAIT_Vignette.pdf  
https://bioconductor.org/packages/release/bioc/vignettes/metaMS/inst/doc/runLC.pdf  
https://bioconductor.org/packages/release/bioc/vignettes/MWASTools/inst/doc/MWASTools.html  
https://bioconductor.org/packages/release/bioc/html/PAPi.html  
https://bioconductor.org/packages/release/bioc/vignettes/statTarget/inst/doc/statTarget.html  
