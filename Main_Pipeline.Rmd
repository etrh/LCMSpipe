...
```{r Identification using MoNa MassBank}
...
identified$metaData[[1]]$value
identified$compound[[1]]$inchi
identified$compound[[1]]$names
identified$compound[[1]]$classification
identified$compound[[1]]$metaData[[1]]
